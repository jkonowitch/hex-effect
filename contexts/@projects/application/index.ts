...
import { Project, ProjectId, ProjectRepository, Task, TaskId, TaskRepository } from "@projects/domain";
...
export class CompleteTask extends Schema.TaggedRequest<CompleteTask>()("CompleteTask", Schema.Never, Schema.Void, {
  taskId: TaskId
}) { }
...
export const createProject = ({ title }: CreateProject) => Effect.gen(function* () {
...
export const completeTask = ({ taskId }: CompleteTask) => Effect.gen(function* () {
